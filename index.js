...
// Join the Discord for support: https://discord.gg/uqVHYrBed9  -Huysuz
...
(async ()=>{
  ...
  console.log(chalk.bold('Sponsored by', chalk.hex('#5A96F6')('Huysuz')));
  console.log(`Huysuz community to help you build your own bot`);
  console.log(`----> ${chalk.green.bold(`https://discord.gg/uqVHYrBed9`)} <----\n`);
  console.png(require('path').join(__dirname, 'assests', 'huysuz.png'))
})();
